...
## Notes
- Primary repo surfaces: .env.example, .gitignore, CLAUDE.md, README.md, adapter, clipmart-template.json, docker-compose.n8n.yml, docker-compose.yml
- Additional notes outside the managed block are preserved during automatic sync.
